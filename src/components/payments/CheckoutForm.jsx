...
const CheckoutForm = ({ testPrice, refetch, closeModal, booking,handleBookNow }) => {
    ...
    useEffect(() => {
        ...
        if (testPrice && testPrice > 0) {
            // console.log(testPrice && testPrice > 0)
            getClientSecret({ price: testPrice })
        }
    }, [testPrice]);
